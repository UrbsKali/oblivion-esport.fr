...
<footer
	class="flex p-4 text-center text-white bg-gray-900 border-t border-gray-700 backdrop-blur-lg"
>
		...
		<div class="flex gap-2 py-2">
			...
			<a href="https://twitter.com/oblivion_fr" target="_blank">
				<svg
					class="shareX"
					viewBox="0 0 15 13"
					style="width:20px;height:16px;display:block;fill:currentColor;flex-shrink:0"
					><path
