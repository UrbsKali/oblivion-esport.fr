...
<svelte:head>
	...
	<meta name="msapplication-TileImage" content="https://oblivion-esport.fr/assets/oblivion.webp" />
	...
	<meta name="og:image" content="/assets/oblivion.webp" />
...
<div class="flex flex-col items-center justify-center w-screen">
	<h1 class="text-4xl font-semibold text-white">Rechercher un joueur - Statistiques TWC 5</h1>
	<div class="p-5 w-96">
		<div class="relative w-full">
			...
			<input
				type="text"
				id="simple-search"
				class="block w-full p-2 pl-10 text-sm text-white placeholder-gray-400 bg-gray-700 border border-gray-600 rounded-lg focus:ring-primary-500 focus:border-primary-500"
			...
			{#if isFocus || !(completion.length == 1 && name == completion[0])}
				<div
					class="absolute z-10 block w-full p-2 pl-10 mt-1 text-sm text-white bg-gray-700 border border-gray-600 rounded-lg focus:ring-primary-500 focus:border-primary-500"
				>
...
<style>
	#lose {
		mask-image: url('/assets/stats/Armor_penetration_icon.png');
		mask-size: 100% 100%;
	}
	#win {
		mask-image: url('/assets/stats/Win.png');
		mask-size: 100% 100%;
	}
	#game {
		mask-image: url('/assets/stats/game.png');
		mask-size: 100% 100%;
	}
	#gold {
		mask-image: url('/assets/stats/gold.png');
		mask-size: 100% 100%;
	}
	#minion {
		mask-image: url('/assets/stats/Minion_icon.png');
		mask-size: 100% 100%;
	}
	#damage {
		mask-image: url('/assets/stats/Damage.png');
		mask-size: 100% 100%;
	}
	#assist {
		mask-image: url('/assets/stats/Assist.png');
		mask-size: 100% 100%;
	}
	#death {
		mask-image: url('/assets/stats/Death.png');
		mask-size: 100% 100%;
	}
	#kill {
		mask-image: url('/assets/stats/Kill.png');
		mask-size: 100% 100%;
	}
</style>
